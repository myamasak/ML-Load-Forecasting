...
def randomForestCalc(X_, y_):
    ...
    with np.printoptions(precision=4, suppress=True):
        print(scores)
    print("Loss: {0:.4f} (+/- {1:.4f})".format(scores.mean(), scores.std()))

    # print("Running Random Forest CrossValidation Blocking Time Series Split...")
    ...
    print("\n--- \t{:0.3f} seconds --- Random Forest Cross-validation ".format(time.time() - start_time_randomforest)) 
